...
class _EditorPanelState extends State<EditorPanel> {
  ...
  void _checkForChanges() {
    ...
    if (_albumArtistController.text != (tags?.albumArtist ?? '')) hasChanges = true;
                      ...
                      child: Column(
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: const InputDecoration(labelText: 'Album Artist', prefixIcon: Icon(Icons.person_outline)),
                            onChanged: isBatch ? (val) => appState.updateBatchTemplate(albumArtist: val) : null,
                          ),
                          const SizedBox(height: 12),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
